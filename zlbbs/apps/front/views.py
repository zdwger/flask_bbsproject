...
from .forms import SigupForm,SigninForm,AddPostForm,AddCommentForm
...
class SignupView(views.MethodView):
    def get(self):
        return_ro = request.referrer
        if return_ro and return_ro != request.url and safeutils.is_safe_url(return_ro):
            return render_template('front/front_signup.html',return_ro=return_ro)
        else:
